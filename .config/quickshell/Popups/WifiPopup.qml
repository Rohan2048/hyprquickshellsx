        ...
        ColumnLayout {
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    // Was "true" — same permanently-allocated FBO + shader
                    // pass bug fixed elsewhere in this shell (see
                    // VolumePopup/BluetoothPopup). crossfadeBlur is 0
                    // whenever opacity is 0 or 1, i.e. almost all the time
                    // this popup sits open — only layer during the actual
                    // live/saved crossfade.
                ...
                ColumnLayout {
                    ...
                    property real crossfadeBlur: Math.sin(Math.PI * opacity) * Animations.slideBlurHorizontalLength
                    // Was "true" — same fix as liveSection above.
                    layer.enabled: opacity < 1
                    layer.effect: DirectionalBlur {
                        angle: Animations.slideBlurHorizontalAngle
