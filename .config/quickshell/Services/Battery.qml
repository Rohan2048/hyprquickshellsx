...
QtObject {
    ...
    property Process _govProc: Process {
        ...
        "exec tail -f /tmp/quickshell/cpu_governor_trigger 2>/dev/null"]
        running: true
        stdout: SplitParser {
            splitMarker: "\n"
    ...
    property Process _tunedProc: Process {
        ...
        "exec tail -f /tmp/quickshell/tuned_profile_trigger 2>/dev/null"]
        running: true
        stdout: SplitParser {
            splitMarker: "\n"
    ...
    property Process _turboProc: Process {
        ...
        "exec tail -f /tmp/quickshell/turbo_state_trigger 2>/dev/null"]
        running: true
        stdout: SplitParser {
            splitMarker: "\n"
